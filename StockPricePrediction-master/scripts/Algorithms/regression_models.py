...
from regression_helpers import load_dataset, addFeatures, mergeDataframes, count_missing, applyTimeLag, performRegression, performClassification
import sys
import os
import pickle
import traceback
...
def main(dir_path, output_dir):
    ...
    for file_name in files:
        try:
            ...
            finance = finance.interpolate('linear')
...
#             mean_squared_errors, r2_scores = performClassification(finance, 0.95, symbol, output_dir)
